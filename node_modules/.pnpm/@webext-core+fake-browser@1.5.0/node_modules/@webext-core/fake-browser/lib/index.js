...
var windows = {
  ...
  remove(windowId) {
    return __async(this, null, function* () {
      ...
      yield onRemoved.trigger(windowId);
    });
  },
  onCreated,
  onRemoved,
  ...
  create(createProperties) {
    return __async(this, null, function* () {
      ...
      const newTab = {
        highlighted: false,
        incognito: false,
        index: (_b = (_a = window == null ? void 0 : window.tabs) == null ? void 0 : _a.length) != null ? _b : 0,
        pinned: (_c = createProperties.pinned) != null ? _c : false,
        windowId: (_d = window == null ? void 0 : window.id) != null ? _d : 0,
        id: getNextTabId(),
    ...
    return __async(this, null, function* () {
      ...
      return tabList.filter((tab) => {
        ...
        if (queryInfo.windowId != null)
          res = res && tab.windowId === queryInfo.windowId;
...
// src/apis/action.ts
var onClicked2 = defineEventWithTrigger();
var DEFAULT_BADGE_BACKGROUND_COLOR = "#5F5D5B";
var DEFAULT_BADGE_TEXT_COLOR = "#FFFFFF";
var badgeTextColorState = {
...
var action = {
  ...
  setTitle(details) {
    ...
    if (tabId !== void 0) {
      ...
      titleState.global = title != null ? title : "";
    }
  ...
  setBadgeText(details) {
    ...
    if (tabId !== void 0) {
      ...
      badgeTextState.global = text != null ? text : "";
    }
    return Promise.resolve();
  },
  ...
  getBadgeBackgroundColor(details) {
    ...
    return Promise.resolve(value != null ? value : hexToRgbaArray(DEFAULT_BADGE_BACKGROUND_COLOR));
  },
  ...
  getBadgeTextColor(details, callback) {
    ...
    callback == null ? void 0 : callback(value != null ? value : DEFAULT_BADGE_TEXT_COLOR);
  },
